class MyMessage(object):
    ...
    MSG_ARG_KEY_GLOBAL_TRAINING_LOSS = "global_training_loss"
    MSG_ARG_KEY_LOCAL_ACC = "local_accuracy"
    MSG_ARG_KEY_FLOPS = "flops"
    MSG_ARG_KEY_MODEL_SIZE = "model_size"
    MSG_ARG_KEY_CLIENT_INDEX = "client_index"
    MSG_ARG_KEY_LOCAL_REG_LOSS = "reg_loss"
    MSG_ARG_KEY_ALPHA_VAL = "alpha_val"
