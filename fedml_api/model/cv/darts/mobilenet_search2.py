...
class MobileNet_Network2(nn.Module):
    ...
    def forward(self, input):
        mixed_hidden_feature = self.backbone_model(input) #[2, 2560, 7, 7]
        #dimensions = list(mixed_hidden_feature.shape)
        logits = self.classifier(mixed_hidden_feature.view(mixed_hidden_feature.size(0), -1))  # C_prev, number of classes
        return logits
