...
OPS = {
    ...
    'conv_7x1_1x7': lambda C, stride, affine: nn.Sequential(
        ...
        # nn.GroupNorm(8, C, affine=affine),
...
class ReLUConvBN(nn.Module):
    ...
    def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
        ...
        #     # nn.GroupNorm(8, C_out, affine=affine),
...
class SepConv(nn.Module):
    ...
    def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
        ...
        #     # nn.GroupNorm(8, C_in, affine=affine),
        ...
        self.bn = nn.BatchNorm2d(C_in, affine=affine)
            # nn.GroupNorm(8, C_in, affine=affine),
            # nn.BatchNorm2d(C_in, affine=affine),
        self.op2 = nn.Sequential(nn.ReLU(inplace=False),
            nn.Conv2d(C_in, C_in, kernel_size=kernel_size, stride=1, padding=padding, groups=C_in, bias=False),
            nn.Conv2d(C_in, C_out, kernel_size=1, padding=0, bias=False),
        )
            # nn.GroupNorm(8, C_out, affine=affine),
...
class FactorizedReduce(nn.Module):
    ...
    def __init__(self, C_in, C_out, affine=True):
        ...
        # self.bn = nn.GroupNorm(8, C_out, affine=affine)
        self.bn = nn.BatchNorm2d(C_out, affine=affine)
